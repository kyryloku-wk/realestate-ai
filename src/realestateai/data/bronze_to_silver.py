...
if __name__ == "__main__":
    df = query_to_dataframe("""SELECT * FROM extracted_payload""")

    final_df = transform_payloads_df(df)
    save_df_to_postgres(final_df, table="listings_silver", if_exists="replace", chunksize=100)
